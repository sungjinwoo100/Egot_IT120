...
Who Am I@DESKTOP-UCRK8PB MINGW64 ~/desktop/Egot_IT120_Act01 (Egot_B4)
$ rm -rf .git
...
Who Am I@DESKTOP-UCRK8PB MINGW64 ~/desktop/Egot_IT120_Act01 (master)
$ git checkout -b Egot_B3
Switched to a new branch 'Egot_B3'

Who Am I@DESKTOP-UCRK8PB MINGW64 ~/desktop/Egot_IT120_Act01 (Egot_B3)
$ echo "Person to Contact: Angelisa M. Egot
Address: R.T.R,ADN, Philippines" >> Background.txt
...
Who Am I@DESKTOP-UCRK8PB MINGW64 ~/desktop/Egot_IT120_Act01 (Egot_B3)
$ git commit -m "Added contact info in Background.txt and removed Test.py"
[Egot_B3 f698160] Added contact info in Background.txt and removed Test.py
...
Who Am I@DESKTOP-UCRK8PB MINGW64 ~/desktop/Egot_IT120_Act01 (master)
$ git checkout -b Egot_B4
Switched to a new branch 'Egot_B4'
